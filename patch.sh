...
grep -q 'private long mLastMenuDismissedAtMs;' "$MENU_COORDINATOR" || sed -i '/ExtensionsMenuMediator mMediator;/a\    private long mLastMenuDismissedAtMs;' "$MENU_COORDINATOR"
