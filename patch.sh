...
grep -q 'private final ExtensionsToolbarBridge mToolbarBridge;' chrome/browser/ui/android/toolbar/java/src/org/chromium/chrome/browser/toolbar/extensions/ExtensionsMenuMediator.java || sed -i '/private final ExtensionsMenuBridge mMenuBridge;/a\    private final ExtensionsToolbarBridge mToolbarBridge;' chrome/browser/ui/android/toolbar/java/src/org/chromium/chrome/browser/toolbar/extensions/ExtensionsMenuMediator.java
sed -i '/new ExtensionsMenuBridge(mTask, mProfile, toolbarBridge, \/* observer= \*\/ this);/a\        mToolbarBridge = toolbarBridge;' chrome/browser/ui/android/toolbar/java/src/org/chromium/chrome/browser/toolbar/extensions/ExtensionsMenuMediator.java
